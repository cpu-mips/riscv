...
add wave AsmTestbenchCaches/mem_arch/cache_bypass/*
add wave AsmTestbenchCaches/mem_arch/req_con/*
add wave AsmTestbenchCaches/DUT/*
add wave AsmTestbenchCaches/DUT/dpath/*
add wave AsmTestbenchCaches/DUT/ctrl/*
add wave AsmTestbenchCaches/DUT/dpath/ua/*
add wave AsmTestbenchCaches/DUT/dpath/regfile/*
run 10000us
